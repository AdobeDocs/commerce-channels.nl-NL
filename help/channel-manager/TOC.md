...
user-guide-description: "Verhoog verkoop en breid uw klantenbasis uit door Adobe Commerce of Magento Open Source met uw  [!DNL Walmart Marketplace]  Centrale rekening van de Verkoper te integreren."
...
# Channel Manager - [!DNL Channel Manager] voor Adobe Commerce {#channel-manager}
...
- Aan boord [!DNL Channel Manager] {#on-boarding}
   ...
   - [Installeer de  [!DNL Channel Manager]  uitbreiding](install.md)
   - [Verbinding maken met Commerce Services](connect.md)
...
- Overzicht en prijzen {#inventory-pricing}
