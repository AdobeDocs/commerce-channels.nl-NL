...
Als een aanbiedingsregel op meerdere websites van toepassing is, wordt de volgorde waarin de websiteprijs wordt gebruikt bepaald door de instelling voor de prioriteit van de website die in het dialoogvenster [aanbiedingsregel](./listing-rules.md). Met deze regels kunt u productprijzen in de hele catalogus definiëren. Ga naar [Bereik catalogusprijs](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/pricing/catalog-price-scope.html).
