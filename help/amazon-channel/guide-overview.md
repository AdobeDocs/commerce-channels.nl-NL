---
title: '[!DNL Amazon Sales Channel] Handleiding'
...
Deze handleiding bevat een aantal basisbeoordelingen [!DNL Amazon Seller Central] informatie, de vereisten voor het instellen van je Amazon-verkoopkanaal. Het bevat ook informatie over het instapproces en het integratieproces, de beschikbare winkel, het product, de prijs en andere opties, en over de manier waarop je Amazon-verkoopkanalen kunt gebruiken om je aanbiedingen en verkopen in het [!DNL Amazon Marketplace]. Gebruik de linkerspoorstaaf om door diverse functionaliteit te navigeren en neer te boren om tot gedetailleerde informatie en procedures toegang te hebben.
...
| [Kenmerken beheren](./attributes-view.md) | Amazon verkoopkanaal wijst producten toe aan jouw [!DNL Commerce] catalogus en Amazon gebruiken van productkenmerken. Meer informatie over het maken, toewijzen en beheren van deze kenmerken. |
...
* [Help Center](https://support.magento.com/hc/en-us)—Zie de [!DNL Amazon Sales Channel]gerelateerde artikelen voor probleemoplossing.
* [Ondersteuningstickets](https://support.magento.com/hc/en-us/articles/360000913794#submit-ticket)—Verstuur een ticket om extra hulp te ontvangen.
